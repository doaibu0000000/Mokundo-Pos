...
interface AppContextType {
  ...
  platform: 'Take Away' | 'GrabFood' | 'GoFood' | 'ShopeeFood';
  setPlatform: (val: 'Take Away' | 'GrabFood' | 'GoFood' | 'ShopeeFood') => void;
  canInstall: boolean;
...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [platform, setPlatform] = useState<'Take Away' | 'GrabFood' | 'GoFood' | 'ShopeeFood'>('Take Away');
